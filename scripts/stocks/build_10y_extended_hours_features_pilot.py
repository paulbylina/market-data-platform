...
TASKS_PATH = Path(
    "data/research/full_market_scanner_10y/daily_regime_event_tasks/extended_hours_1m_regime_tasks_pilot.csv"
)
...
def main():
    ...
    summary.to_csv(OUTPUT_DIR / "extended_hours_features_pilot_summary.csv", index=False)
    print()
    print("saved:", OUTPUT_DIR / "extended_hours_features_pilot_summary.csv")
