...
def main():
    ...
    summary_path = OUTPUT_DIR / "cheap_open_activation_fullsample_summary.csv"
    candidates_path = OUTPUT_DIR / "cheap_quiet_pm_first15_activation_candidates_fullsample.csv"
    ...
    print()
    print("=== Cheap Open Activation Full-Sample Summary ===")
    display_cols = [
        "label",
        "rows",
        "tickers",
