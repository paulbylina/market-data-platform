...
def main():
    ...
    metrics_out = OUTPUT_DIR / "full_pilot_post_first15_path_metrics_by_price_bucket.csv"
    setup_summary_out = OUTPUT_DIR / "full_pilot_post_first15_setup_summary.csv"
    bucket_setup_summary_out = OUTPUT_DIR / "full_pilot_post_first15_bucket_setup_summary.csv"
