...
FEATURES_PATH = Path(
    "data/research/full_market_scanner_10y/high_price_short_fade_features/high_price_short_fade_features.csv"
)
...
def main():
    ...
    metrics_out = OUTPUT_DIR / "high_price_short_fade_post_first15_path_metrics.csv"
    setup_summary_out = OUTPUT_DIR / "high_price_short_fade_setup_summary.csv"
    bucket_setup_summary_out = OUTPUT_DIR / "high_price_short_fade_bucket_setup_summary.csv"
